...
import com.example.jao.alexaandroidclient.SecureOkHttpClient;
import com.example.jao.alexalib.callback.AsyncCallback;
import com.example.jao.alexalib.interfaces.response.ResponseParser;
...
public abstract class SendEvent {
    ...
    OkHttpClient mClient = SecureOkHttpClient.getTLS12OkHttpClient();
     ...
     * @param url the URL we're posting to, this is either the default Directive or Event URL
    ...
    protected void prepareConnection(String url, String accessToken) {
        ...
        // Use multipart file to form the part. It is smart!!!
