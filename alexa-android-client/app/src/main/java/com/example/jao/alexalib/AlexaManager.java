package com.example.jao.alexalib;

import android.content.Context;
import android.os.AsyncTask;

import com.example.jao.alexaandroidclient.R;
import com.example.jao.alexalib.callback.AsyncCallback;
import com.example.jao.alexalib.callback.AuthorizationCallback;
...
import com.example.jao.alexalib.interfaces.GenericSendEvent;
import com.example.jao.alexalib.interfaces.speechrecognizer.SpeechSendAudio;
import com.example.jao.alexalib.interfaces.speechrecognizer.SpeechSendText;
import com.example.jao.alexalib.interfaces.speechrecognizer.SpeechSendVoice;
import com.example.jao.alexalib.interfaces.system.OpenDownchannel;
...
public class AlexaManager {
    ...
    /**
     * Send a synchronize state {@link Event} request to Alexa Servers to retrieve pending Directive
     * @param callback state callback
     */
     ...
     *
     * @param volume volume as reported by the AvsAdjustVolumeItem Directive
     ...
     *
     * @param isMute mute state as reported by the AvsSetMuteItem Directive
     * @param callback
     */
